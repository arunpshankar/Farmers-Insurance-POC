...
output_csv_path = './data/results/exp_3.csv'
joined_csv_path = './data/results/exp_3_joined.csv'
excel_output_path = './data/results/exp_3_joined.xlsx'
...
for query_result in query_results:
    ...
    for rank in citations:
        ans = query_result.get_extractive_segment_by_rank(rank)
        context.append(ans)
    context = '\n\n'.join(context)
